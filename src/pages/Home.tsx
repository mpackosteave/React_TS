        ...
        <div className="min-h-screen bg-slate-50 text-slate-800 font-sans antialiased">
                ...
                <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    <div className="space-y-6">
                        ...
                        <p className="text-slate-500 text-base leading-relaxed max-w-lg">
                            Conception minimaliste, matériaux d'exception et finitions faites à la main. Découvrez notre sélection d'objets du quotidien réinventés.
                        </p>
                        <div className="pt-4 flex items-center space-x-4">
                            <a href="#" className="bg-slate-900 text-white text-sm font-medium px-8 py-3.5 rounded-none hover:bg-indigo-600 transition-colors">
                                Découvrir la collection
                            </a>
                            <a href="#" className="text-slate-600 text-sm font-medium px-6 py-3.5 border border-slate-300 hover:border-slate-900 transition-colors">
                                En savoir plus
                            </a>
                        </div>
                    </div>
            ...
            <section className="py-20 max-w-7xl mx-auto px-6">
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 border-b border-slate-200 pb-6">
                    <div>
                        <h2 className="text-xs font-bold uppercase tracking-widest text-slate-400">Catalogue</h2>
                        <p className="text-2xl font-light text-slate-900 mt-1">Produits Sélectionnés</p>
                    </div>
                    <div className="mt-4 md:mt-0 flex space-x-6 text-sm font-medium text-slate-500">
                        <button className="text-slate-900 font-semibold border-b border-slate-900 pb-0.5">Tous</button>
                        <button className="hover:text-slate-900 transition-colors">Accessoires</button>
                        <button className="hover:text-slate-900 transition-colors">Mobilier</button>
                        <button className="hover:text-slate-900 transition-colors">High-Tech</button>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                        ...
                        <div>
                            <div className="relative aspect-square bg-slate-100 overflow-hidden mb-4">
                                ...
                                <div className="absolute top-3 right-3 flex flex-col space-y-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    <button type="button" className="p-2 bg-white/90 text-slate-700 hover:text-slate-900 rounded-full shadow-sm hover:bg-white transition-colors">
                            ...
                            <div className="flex justify-between items-start mb-4">
                                <div>
                                    ...
                                    <p className="text-xs text-slate-400 mt-1">Accessoires / Audio</p>
                                </div>
                                <p className="text-sm font-semibold text-slate-900">249 €</p>
                            </div>
                        </div>
                        {/* Bouton Action Panier */}
                        <button type="button" className="w-full py-2.5 border border-slate-900 text-slate-900 text-xs font-semibold uppercase tracking-wider hover:bg-slate-900 hover:text-white transition-colors flex items-center justify-center space-x-2">
                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="group flex flex-col justify-between">
                        <div>
                            ...
                            <div className="flex justify-between items-start mb-4">
                                <div>
                                    <h3 className="text-sm font-medium text-slate-900">Essence Botanique 50ml</h3>
